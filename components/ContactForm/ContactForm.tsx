  ...
  return (
    <form className={className} onSubmit={submitHandler}>
      <input
        ...
        id="name"
        name="name"
        className="bg-transparent border-b-[3px] mb-5 mx-10 lg:mx-2 px-2 py-5 outline-none focus:border-accent-color"
        type="text"
        placeholder="Имя"
      />
      <input
      ...
      <button
        type="submit"
        className="bg-[#34BCF2] mt-10 duration-200 rounded-sm hover:bg-opacity-80 py-2 mx-10 sm:mx-0 sm:py-5"
      >
        Отправить
      </button>
    </form>
