      ...
      <div className="mt-8 space-y-1 w-full font-thin">
        <InfoSection label="1. Информация о наличии права аудиторской организации оказывать аудиторские услуги">
          <div className="px-5 sm:px-0 sm:flex sm:flex-col sm:items-center">
            ...
            <div className="flex justify-center h-[200px] md:h-[400px]">
        ...
        <InfoSection label="3. Информация о лицах, связанных с аудиторской организацией">
          <div
            className={`${styles["wrapper-table-three"]}  flex flex-col items-center`}
          >
            <table
              className={`${styles["table-three"]} table-auto max-w-[700px] overflow border-2 border-black min-h-[300px] border-collapse mx-2 sm:mx-10`}
            >
              <tbody className={``}>
                <tr className="border-[1px] border-black">
                  <td className="pl-3 sm:py-2">
                    1. Перечень филиалов и представительств;
                  </td>
                  <td className="pl-3 sm:py-2">
                    1. Филиалы и представительства отсутствуют;
                  </td>
                </tr>
                {/* <tr className="border-[1px] border-black">
                  <td className="pl-3 sm:py-2">
                  ...
                  <td className="pl-3 sm:py-2">
                    2. Дочерние общества отсутствуют;
                  </td>
                </tr> */}
                <tr className="border-[1px] border-black">
                  <td className="pl-3 sm:py-2">
                    2. Наименование организации, по отношению к которой
                    аудиторская организация является дочерним обществом;
                  </td>
                  <td className="pl-3 sm:py-2">
                    2. Материнская компания отсутствует;
                  </td>
                </tr>
                <tr className="border-[1px] border-black">
                  <td className="pl-3 sm:py-2">
                    3. Перечень аудиторских организаций, участвующих в уставном
                    капитале аудиторской организации;
                  </td>
                  <td className="pl-3 sm:py-2">
                    3. Аудиторские организации, участвующие в уставном капитале
                    отсутствуют;
                  </td>
                </tr>
                <tr className="border-[1px] border-black">
                  {/* <td className="pl-3 sm:py-2">
                    4. Размер доли уставного капитала аудиторской организации,
                    принадлежащей всем аудиторам аудиторской организации;
                  </td> */}
                  <td className="pl-3 sm:py-2">
                    4. Размер доли уставного (складочного) капитала аудиторской
                    организации, принадлежащей другим аудиторским организациям;
                  </td>
                  <td className="pl-3 sm:py-2">
                    4. Доля в уставном капитале аудиторской организации в
                    размере 100% принадлежит аудитору, работающему в аудиторской
                    организации по основному месту работы;
                  </td>
                </tr>
                <tr className="border-[1px] border-black">
                  <td className="pl-3 sm:py-2">
                    5. Перечень бенефициарных владельцев аудиторской
                    организации;
                  </td>
                  <td className="pl-3 sm:py-2">
                    5. Аземша Екатерина Александровна, гражданка РФ, страна
                    постоянного проживания – РФ;
                  </td>
                </tr>
                <tr className="border-[1px] border-black">
                  <td className="pl-3 sm:py-2">
                    6. Перечень иностранных граждан, лиц без гражданства,
                    иностранных юридических лиц, международных компаний,
                    являющихся контролирующими лицами аудиторской организации;
                  </td>
                  <td className="pl-3 sm:py-2">6. Отсутствуют;</td>
                </tr>
                <tr className="border-[1px] border-black">
                  <td className="pl-3 sm:py-2">
                    7. Наименование российской и (или) международной сети
                    аудиторских организаций, членом которой является аудиторская
                    организация.
                  </td>
                  <td className="pl-3 sm:py-2">
                    7. В международных и российских сетях аудиторских
                    организаций не состоит.
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <InfoSection label="4. Информация об организации и обеспечении соблюдения аудиторской организацией требований профессиональной этики и независимости">
          <WrapperForText>
            ...
            <ul>
              <li>
                Правилах независимости аудиторов и аудиторских организаций –
                членов СРО ААС, принятые Решением Правления СРО ААС от 27
                декабря 2023 года (протокол № 658), согласно которым все
                руководители и сотрудники аудиторской организации обязаны знать,
                понимать и выполнять требования и ограничения, установленные
                статьей 8 Независимость аудиторских организаций, аудиторов
                Федерального закона 307-ФЗ «Об аудиторской деятельности»;
              </li>
              <li>
                Кодексе профессиональной этики аудиторов, утвержденным решением
                Правления СРО ААС от 22 декабря 2023 г. (протокол № 657);
              </li>
              <li>
                МСК 1 (ISQM 1) «Управление качеством в аудиторских организациях,
                проводящих аудит или обзорные проверки»;
        ...
        <InfoSection label="5. Информация о контроле (надзоре) за деятельностью (качества работы) аудиторской организации">
          ...
          <div className={styles["wrapper-table-five"]}>
            <table className={styles["table-five"]}>
              <thead>
                <tr>
                  {/* <td>
                    Согласно Международному стандарту контроля качества 1
                    «Контроль качества в аудиторских организациях, проводящих
                    аудит и обзорные проверки финансовой отчетности, а также
                    выполняющих прочие задания, обеспечивающие уверенность, и
                    задания по оказанию сопутствующих услуг» до 14.12.2022
                  </td> */}
                  <td>
              ...
              <tbody>
                <tr>
                  {/* <td>
                    а) обязанности генерального директора ООО «Аудиторская
                    группа «Аземша и партнёры» по обеспечению качества услуг,
                    оказываемых аудиторской организацией;
                  </td> */}
                ...
                <tr>
                  ...
                  <td>
                    принятие решения о начале и (или) продолжении работы с
                    клиентом либо работы по определенному заданию;
                  </td>
                </tr>
                <tr>
          ...
          <WrapperForText>
            <p>
              Генеральный директор аудиторской организации заявляет о наличии и
              результативности системы внутреннего контроля аудиторской
              организации, ее соответствии МСК 1 (ISQM 1) «Управление качеством
              в аудиторских организациях, проводящих аудит или обзорные
              проверки». Система внутреннего контроля качества обеспечивает
              разумную уверенность в том, что ООО «Аудиторская группа «Аземша и
              партнёры» и его работники осуществляют проведение аудита и
              оказание сопутствующих аудиту услуг в соответствии с требованиями
            ...
            <p>Год прохождения проверки качества: 2023</p>
            <br />
            <p>
              Меры дисциплинарного и иного воздействия, примененные в отношении
              аудиторской организации в течение года, в котором раскрывается
              информация, и предшествующего ему года: <br />
              Вынесено предупреждение в письменной форме о недопустимости
              нарушения стандартов аудиторской деятельности (Решение №146 от
              10.11.2023, вынесенное специализированным органом, осуществляющим
        ...
        <InfoSection label="6. Информация об аудиторах, работающих в аудиторской организации по трудовому договору">
            ...
            <table className={styles["table-six-desk"]}>
              <thead>
                <tr>
                  ...
                  <th>
                    Аудиторы, имеющие квалификационный аттестат аудитора,
                    выданный СРО в соответствии со ст. 11 ФЗ от 30 декабря 2008
                    г. N 307-ФЗ {'"'}Об аудиторской деятельности{'"'}
                  </th>
                </tr>
              </thead>
              <tbody>
          ...
          <WrapperForText>
            <p>
              ...
              месту работы и по совместительству аудиторов, доля таких аудиторов
              в общей численности аудиторов, работающих в аудиторской
              организации по трудовому договору (по состоянию на 01.01.2024):
            </p>
          </WrapperForText>
          <div className={styles["wrapper-table-six-desk"]}>
            <table className={styles["table-six-desk"]}>
          ...
          <WrapperForText>
            <p>
              ...
              месту работы и по совместительству аудиторов, доля таких аудиторов
              в общей численности аудиторов, работающих в аудиторской
              организации по трудовому договору (по состоянию на 01.12.2023):
            </p>
          </WrapperForText>
          <div className={styles["wrapper-table-six-desk"]}>
            <table className={styles["table-six-desk"]}>
