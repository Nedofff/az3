  ...
  return (
    <main className='pt-28 pb-20 px-2 sm:flex sm:justify-center'>
      ...
      <p>
        ...
        существуют. Для формирования отчетности по МСФО требуется трансформация
        отчетности составленной в соответствии с ФСБУ.
      </p>
      <br />
      <p>
      ...
      <br />
      <h2 className='text-md text-sub-color font-semibold mb-1'>Кому необходима отчетность по МСФО:</h2>
      <ul className="space-y-2">
        ...
        <li>
          ...
          материнская{'"'} компания является иностранной; привлечения зарубежных
          займов и кредитов; прочих целей.
        </li>
      </ul>
      <br />
      <p>
        ...
        предоставления комбинированной финансовой отчетности Группы в кредитные
        организации и организации – контрагенты.
      </p>
      </div>
    </main>
  );
